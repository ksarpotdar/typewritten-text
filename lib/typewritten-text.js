...
export class TypewrittenText extends HTMLElement {
    ...
    tick = () => {
        ...
        if (!reversed || this.repeat) {
            ...
            if (this.stopTick) {
        let tickerElement =
          this.querySelectorAll(".typewritten-text_character.typewritten-text_current.typewritten-text_revealed").length > 0  ? this.querySelectorAll(".typewritten-text_character.typewritten-text_current.typewritten-text_revealed") : null;
